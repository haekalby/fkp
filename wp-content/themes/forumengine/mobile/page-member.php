...
<div data-role="content" class="fe-content fe-content-auth">
	<div class="fe-page-heading">
		...
		<ul class="fe-thread-actions fe-author-actions nav nav-tabs">
			<li>
				<a class="fe-act ui-link" target="_self" href="<?php echo et_get_page_link('edit-profile') ?>"><span class="fe-icon fe-icon-doc"></span> <?php _e('Edit Profile', ET_DOMAIN) ?></a>
			</li>
			<li>
				<a class="ui-link" rel="external" href="#more_info" data-toggle="tab"><span class="fe-icon fe-icon-doc"></span> <?php _e('Show info', ET_DOMAIN) ?></a>
			</li>
		...
		<div id="more_info" class="tab-pane fe-author-detail">
			...
			<div class="fe-info fe-container fe-info-contact">
				...
				<ul class="fe-info-items">
					...
					<li class="fe-info-item fe-icon-b fe-icon-b-phone fe-info-phone"><?php echo esc_attr( $user_mobile ); ?></li>
				</ul>
			</div>
			<?php } ?>
			<div class="fe-info fe-container fe-info-contact">
				...
				<ul class="fe-info-items">
					<li class="fe-info-item fe-icon-b fe-icon-b-fb fe-info-fb"><?php echo esc_attr( $user_facebook ) ?></li>
					<li class="fe-info-item fe-icon-b fe-icon-b-twitter fe-info-twitter"><?php echo esc_attr( $user_twitter ) ?></li>
					<li class="fe-info-item fe-icon-b fe-icon-b-google fe-info-google"><?php echo esc_attr( $user_gplus ) ?></li>
				</ul>
			</div>
			<div class="fe-info fe-container fe-info-contact">
				<div class="fe-info-title">
